...
//arrow functions can't be used as object constructors
...
//    "this" is the object Student and the output is Student {name: 'Joe', age: 'Schmoe', hometown: 100}
// 2. What is "this" when joe.scopeArrow() is invoked?
//    "this" is global object and outputs Window {window: Window, self: Window, document: document, name: '', location: Location, …}
// 3. Explain why "this" is different when an arrow function is used.
//    Arrow function expressions should only be used for non-method functions because they do not have their own "this". So instead they retain the "this" value of teh enclosing functional scope which in this example is the global window object. 